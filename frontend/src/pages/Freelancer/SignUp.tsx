...
import { sign_up_client, sign_up_freelancer } from '../../utils/requestAddresses'
import { FirebaseError } from 'firebase/app'
import { selectAvatarRoute, talentSignIn } from '../../utils/frontendRoutes'
        ...
        <div className='min-h-[93vh] bg-defaultGray flex justify-center items-center'>
            <div className='flex flex-col gap-3.5 '>
                ...
                <form onSubmit={(e) => {
                    ...
                    <div onClick={() => { navigate(talentSignIn) }} className='text-[11px] cursor-pointer hover:underline'>{t('already-have-an-account')}</div>

...
import { sign_in_freelancer, sign_up_freelancer } from '../../utils/requestAddresses'
...
import { talentSignUp } from '../../utils/frontendRoutes'
    ...
    const handleSubmit = async () => {
        ...
        if (parsingResult.error) {
            ...
            try {
                ...
                const result2 = await axios.post(sign_in_freelancer, {
                    email: emailInput
                }, { withCredentials: true })

                // NAVIGATE THE CLIENT
                if (result2.data.success) {
                    navigate(whereToNavigateTo(result2.data.freelancer))
                }
            } catch (error: unknown) {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            try {
                ...
                const result2 = await axios.post(sign_up_freelancer, {
                    fullName: fullName,
                    email: email,
        ...
        <div className="min-h-[93vh] bg-defaultGray flex justify-center items-center">
            <div className="flex flex-col gap-3.5">
                ...
                <form onSubmit={(e) => {
                    ...
                    <div onClick={() => { navigate(talentSignUp) }} className='text-[11px] cursor-pointer hover:underline'>{t('dont-have-an-account')}</div>
